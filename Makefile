...
mypy   := $(run) mypy
twine  := $(run) twine
vermin := $(run) vermin -v --no-parse-comments --backport dataclasses --backport typing --eval-annotations --backport argparse --backport enum
...
clean:				# Clean the build directories
	rm -rf build dist $(app)_cli.egg-info
